function calculateHandMovementFrequency_openpose(output_name)
...
%%
outputs.index_down_times = events_openpose.index_down_frames/videoInfo.vid_openpose.FrameRate;

for ii = 2:length(events_openpose.index_down_frames)
    outputs.movement_times(ii-1,1) = (events_openpose.index_down_frames(ii)-events_openpose.index_down_frames(ii-1))/videoInfo.vid_openpose.FrameRate;
