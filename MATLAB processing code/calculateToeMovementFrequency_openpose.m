function calculateToeMovementFrequency_openpose(output_name)
...
%%
outputs.toe_down_times = events_openpose.toe_down_frames/videoInfo.vid_openpose.FrameRate;

for ii = 2:length(events_openpose.toe_down_frames)
    outputs.movement_times(ii-1,1) = (events_openpose.toe_down_frames(ii)-events_openpose.toe_down_frames(ii-1))/videoInfo.vid_openpose.FrameRate;
