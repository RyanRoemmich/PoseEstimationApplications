function gapFillBody_filter_openpose(output_name)
clearvars -except output_name
file = sprintf('%s%s',output_name,'_openpose.mat');
cd = pwd;
%%
noLandmarks = 25; % hand model
...
frameInfo.isGapFilled.x = false(noFiles,noLandmarks); % logical matrix showing which frames are gap filled
frameInfo.isGapFilled.y = false(noFiles,noLandmarks); % logical matrix showing which frames are gap filled
